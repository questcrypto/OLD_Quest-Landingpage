...
const KnabCountDown = () => {
  ...
  useEffect(() => {
    ...
    let data = setInterval(function () {
      ...
      setTime({ ...time, days: days, hours: hours, minutes: minutes, seconds: seconds })
    ...
    <div id="ico" className={classes.root}>
      ...
      <div className={classes.smDiv}>
        ...
        <div className={classes.smIcons}>
          <img src={Telegram} alt="Telegram" onClick={() => openUrl(telegram)} className={classes.smIcon} />
          <img src={Reddit} alt="Reddit" onClick={() => openUrl(reddit)} className={classes.smIcon} />
          <img src={Twitter} alt="Twitter" onClick={() => openUrl(twitter)} className={classes.smIcon} />
          <img src={Instagram} alt="Instagram" onClick={() => openUrl(instagram)} className={classes.smIcon} />
        </div>
      </div>
